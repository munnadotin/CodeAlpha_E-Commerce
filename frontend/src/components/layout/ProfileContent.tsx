            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    {user.address && user.address.length > 0 ? (
                        <div className="group relative space-y-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                            {user.address.map((address, index) => (
                                <div
                                    key={index}
                                    className="rounded-xl flex items-start justify-between border border-gray-200 bg-white p-4 transition hover:shadow"
                                >
